...
/**
 * Verifies one classified candidate: invalid rows short-circuit, CDN URLs
 * go through the filesystem check with transform fallback, and absolute
 * HTTP(S) URLs go through the remote probe.
 */
