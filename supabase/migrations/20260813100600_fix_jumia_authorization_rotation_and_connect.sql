-- Fix Jumia Self Authorization follow-ups:
-- 1. Allow scoped credential rotation without granting direct table UPDATE.
-- 2. Treat inactive-row reactivation as a successful connect result.
...
BEGIN
  ...
  IF v_merchant_id IS NULL OR NOT (
    EXISTS (
      SELECT 1
