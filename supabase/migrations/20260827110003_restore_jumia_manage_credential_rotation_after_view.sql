-- Restore credential rotation to the integrations.manage boundary after the
-- active-view refresh experiment. Read-only routes must use a trusted path
-- that has already authorized the merchant operation.
