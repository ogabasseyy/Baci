-- Checkout quote refresh must stay on a service-role writer so merchants cannot
-- forge provider_metadata / economics through PostgREST. Wallet refreshes use a
-- separate authenticated, order-scoped attestation writer.
...
BEGIN
  ...
  INSERT INTO public.shipping_quotes (
    ...
    v_quote_id, v_merchant_id, v_session_id, v_provider,
    ...
    p_quote->>'pricing_version', v_currency,
