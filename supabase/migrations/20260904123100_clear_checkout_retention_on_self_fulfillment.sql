-- Allow trusted self-fulfillment to clear customer-checkout GIGL retention.
-- Without this, stamp_gigl_order_economics restores checkout economics and later
-- settlement still withholds shipping for merchant-delivered orders.
