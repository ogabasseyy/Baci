-- Close economics projection when selected_quote_id is null: require either
-- the order's selected quote or an order-scoped attestation before returning
-- internal economics for an arbitrary merchant quote.
