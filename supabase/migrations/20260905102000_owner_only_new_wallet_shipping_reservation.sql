-- Staff may recover an existing reserved/provider_submitting charge, but creating
-- a new wallet debit must stay owner-only (first-release wallet funding invariant).
...
BEGIN
  ...
  -- New wallet debits move owner funds; staff recovery of existing rows is above.
  IF NOT v_is_owner THEN
    RAISE EXCEPTION 'wallet_reservation_owner_required' USING ERRCODE = '42501';
  END IF;
