...
try {
  ...
  for (const filename of ['20260913090200_uba_redvault_partial_refund_inventory_reconciliation.sql', '20260913090300_uba_redvault_remaining_capture_refunds.sql', '20260913090400_uba_redvault_attempt_persistence_and_replay_guards.sql', '20260913090500_uba_redvault_review_followups.sql', '20260913090600_uba_redvault_followup_hardening.sql']) sql(readFileSync(resolve(migrations, filename), 'utf8'));
