...
*/5 *  * * * flock -n $REMOTE_DIR/locks/process-redvault-refunds.lock bash -lc 'cd $REMOTE_DIR && $NODE_BIN $REMOTE_DIR/jobs/run-web-cron.mjs /api/cron/process-redvault-refunds' >> $REMOTE_DIR/logs/process-redvault-refunds.log 2>&1
